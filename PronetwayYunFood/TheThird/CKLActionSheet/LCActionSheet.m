...
+ (instancetype)sheetWithTitle:(NSString *)title buttonTitles:(NSArray *)titles redButtonIndex:(NSInteger)buttonIndex cancelBtnText:(NSString *)text delegate:(id<LCActionSheetDelegate>)delegate {
    
    return [[self alloc] initWithTitle:title buttonTitles:titles redButtonIndex:buttonIndex cancelBtnText:text delegate:delegate];
}

- (instancetype)initWithTitle:(NSString *)title
                 buttonTitles:(NSArray *)titles
               redButtonIndex:(NSInteger)buttonIndex
                cancelBtnText:(NSString *)text
...
- (void)didClickBtn:(UIButton *)btn {
    ...
    if ([_delegate respondsToSelector:@selector(actionSheet:didClickedButtonAtIndex:didClickBtn:)]) {
        
        [_delegate actionSheet:self didClickedButtonAtIndex:btn.tag didClickBtn:btn];
    }
}
...
- (void)didClickCancelBtn {
    ...
    [UIView animateWithDuration:0.3f delay:0 options:UIViewAnimationOptionCurveEaseOut
    animations:^{
