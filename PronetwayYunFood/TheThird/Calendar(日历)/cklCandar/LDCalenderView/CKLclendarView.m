...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        [CancerBtn setImage:[UIImage imageNamed:@"backcander"] forState:(UIControlStateNormal)];
        ...
        [UIView animateWithDuration:.75f
             ...
             usingSpringWithDamping:0.65f
              initialSpringVelocity:0.5
                         ...
                         animations:^{
                            _contentBgView.frame = CGRectMake((SCREEN_WIDTH-UNIT_WIDTH*kCol)/2.0, 100, UNIT_WIDTH*kCol, 42+UNIT_WIDTH*kCol+50);
                         }
                         completion:^(BOOL finished) {
                             
                             lineM.frame = CGRectMake(kWidth/2, _contentBgView.endY, 2, 73);
                             CancerBtn.frame = CGRectMake((kWidth-32)/2, lineM.endY, 32, 32);
...
- (void)_doneBtnClick:(id)sender
{
    ...
    if (_indexForSelect == 1) {
        
        //[WSProgressHUD showWithStatus:@"请选择结束时间" maskType:WSProgressHUDMaskTypeDefault];
        [WSProgressHUD showShimmeringString:@"请选择生效时间" maskType:(WSProgressHUDMaskTypeDefault)];
...
-(void)cancerBtnClick{
    [UIView transitionWithView:_dateBgView duration:0.5f options:UIViewAnimationOptionCurveEaseOut animations:^{
