...
-(UIColor *)backgroundColorForSection:(NSInteger )section
{
    ...
    return kWhiteColor;//[UIColor colorWithRed:222/255.f green:222/255.f blue:222/255.f alpha:1.f];
}
...
-(UIImage *)arrowImageForSection:(NSInteger )section
{
    ...
    return [UIImage imageNamed:@"Yun_home_addCai_jiantou"];
}
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    UIView *vc = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kWidth-30*newKwith, 10*newKhight)];
    vc.backgroundColor = kWhiteColor;
    return vc;
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_foldingDelegate && [_foldingDelegate respondsToSelector:@selector(yuFoldingTableView:didSelectRowAtIndexPath:)]) {
        ...
        [self yuFoldingSectionHeaderTappedAtIndex:indexPath.section];
